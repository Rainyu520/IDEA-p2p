            ...
            <div class="login-cnt reg-body clearfix">
                <div class="fl">
                    ...
                    <div class="login-form reg-form">
                        ...
                        <div class="login-box clearfix" style="z-index:100;">
                            <label>手机号码</label>
                            <input type="text" id="phone" name="phone" class="input_text" maxlength="11" placeholder="请输入手机号码" autocomplete="off" />
                            <span class="loading" style="display:none;"></span>
                        ...
                        <div class="login-box clearfix" style="z-index:60;">
                            <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                            <%--<div class="yzm-box">
                                <input id="messageCode" name="messageCode" type="text" class="yzm" maxlength="10" placeholder="点击获取验证码" />
                        ...
                        <div class="login-box clearfix " style="z-index:90;">
                            <label>身份证号</label>
                            <input type="text" id="idCard" name="idCard" class="input_text" maxlength="20"  placeholder="请输入身份证号码" autocomplete="off" />
                        ...
                        <div class="login-box clearfix" style="z-index:80;">
                            <label>银行卡卡号</label>
                            <input type="text" id="bankCardNo" name="bankCardNo" class="input_text" placeholder="请输入银行卡卡号"/>
