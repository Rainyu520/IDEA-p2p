...
<head>
    ...
    <style type="text/css">
        .testBtn-a{display: inline-block;height:30px;line-height:30px;padding:0 5px; border:0; border-radius:0px;color:#fff;background:rgb(65,133,244);cursor: pointer;}
        ...
        <div class="homeWap">
            <div class="login-cnt clearfix">
                ...
                <div class="login-right">
                    ...
                    <div class="currently">
                        平台用户数：<span id="user"><span id="UserCount"></span></span>位，累计成交额：<span id="countMoney"></span>
                        <span id="gold">--</span>元
                    </div>
