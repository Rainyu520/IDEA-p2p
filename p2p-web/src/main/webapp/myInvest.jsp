                    ...
                    <div class="deal-data">
                        <dl>
                            ...
                            <div class="touzi_fenye" style="width:100%;text-align:center;">
                                共${bidInfoTotal}条${totalPage}页　当前为第 ${currentPage} 页
