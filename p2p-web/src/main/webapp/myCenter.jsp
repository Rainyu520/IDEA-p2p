        ...
        <div class="credenMain clearfix">
            ...
            <div class="credenBasic">
                <div class="credenName">
                    ...
                    <h4></h4>
                    <h4>${sessionUser.phone}</h4>
                    <h4>最近登录：<fmt:formatDate value="${sessionUser.lastLoginTime}" pattern="yyyy-MM-dd HH:mm:ss" /></h4>
                </div>
        ...
        <div class="allInvest clearfix">
            <div class="eachInvest invest-tab">
                ...
                <div class="invest-tab-box">
                    <dl>
                        ...
                        <c:forEach items="${bidInfoList}" var="bidInfo" varStatus="bidInfoListStatus">
                            <dd>
                                <span class="name">${bidInfoListStatus.count}</span>
                                <span class="number">${bidInfo.loanInfo.productName}</span>
                                <span  class="money"><fmt:formatNumber value="${bidInfo.bidMoney}" type="currency"/></span>
                                <span  class="profit"><fmt:formatDate value="${bidInfo.bidTime}" pattern="yyyy-MM-dd"/> </span>
                            </dd>
                        </c:forEach>
            ...
            <div class="eachInvest invest-tab invest-tab-box">
                ...
                <dl>
                    ...
                    <c:forEach items="${rechargeRecords}" var="rechargeRecord" varStatus="rechargeRecordsStatus">
                        <dd>
                            <span class="name">${rechargeRecordsStatus.count}</span>
                            <span  class="number">${rechargeRecord.rechargeDesc}</span>
                            <span  class="money"><fmt:formatNumber value="${rechargeRecord.rechargeMoney}" type="currency"/> </span>
                            <span  class="profit"><fmt:formatDate value="${rechargeRecord.rechargeTime}" pattern="yyyy-MM-dd"/> </span>
                        </dd>
                    </c:forEach>
            ...
            <div class="eachInvest recent-earnings">
                ...
                <dl id="recentearning">
                    ...
                    <c:forEach items="#{incomeRecords}" var="incomeRecord" varStatus="incomeRecordsStatus">
                        <dd>
                            <span class="number" style="text-align:left;">${incomeRecordsStatus.count}</span>
                            <span class="number">${incomeRecord.loanInfo.productName}</span>
                            <span class="number name" style="text-align:center;"><fmt:formatDate value="${incomeRecord.incomeDate}" pattern="yyyy-MM-dd"/> </span>
                            <span class="profit"><fmt:formatNumber value="${incomeRecord.incomeMoney}" type="currency"/> </span>
