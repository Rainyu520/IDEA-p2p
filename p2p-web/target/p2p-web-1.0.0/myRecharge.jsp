                    ...
                    <div class="deal-data">
                        <dl>
                            ...
                            <c:forEach items="${rechargeRecordList}" var="rechargeRecord" >
                                <dd>
                                    <div class="deal-time"><fmt:formatDate value="${rechargeRecord.rechargeTime}" pattern="yyyy-MM-dd"/> </div>
                                    <div class="deal-name">${rechargeRecord.rechargeDesc}</div>
                                    <div class="deal-type" style="width:120px">充值</div>
                                    <div class="deal-money"><fmt:formatNumber type="currency" value="${rechargeRecord.rechargeMoney}" /></div>
                                    <c:choose>
                            ...
                            <div class="touzi_fenye" style="width:100%;text-align:center;">
                                共${rechargeRecordTotal}条${totalPage}页　当前为第 ${currentPage} 页
