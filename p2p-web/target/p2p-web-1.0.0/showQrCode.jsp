  ...
  <div class="fund-guanli clearfix">
   ...
   <div class="right-body">
    ...
    <div class="unrecognized" style = "display:block;" id="unrecognized1">
     <h3>充值金额：${rechargeMoney} &nbsp;&nbsp; 充值订单号：${rechargeNo}  &nbsp;&nbsp; 充值时间<fmt:formatDate value="${rechargeTime}" pattern="yyyy-MM-dd HH:mm:ss" /></h3>
     <img src="${pageContext.request.contextPath}/loan/generalQrCode?rechargeMoney=${rechargeMoney}&rechargeNo=${rechargeNo}" />
     <%--   <img src="${pageContext.request.contextPath}/img/qrCode.jpg" />--%>
    </div>
